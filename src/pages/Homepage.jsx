...
import vitaminD3Img from "../assets/vitamin-d3.png";
import omega3Img from "../assets/omega3.jpg";
import antisepticImg from "../assets/antiseptic.jpg";
...
const categories = [
  ...
  {
    name: "Vitamins",
    description: "Daily multivitamin essentials",
    icon: "🧬",
  },
  { name: "Skin Care", description: "Dermatologist recommended", icon: "🧴" },
  {
    name: "Heart Health",
    description: "Cardio support & monitoring",
    icon: "❤️",
  },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-slate-100">
      ...
      <main>
          ...
          <div className="mx-auto flex max-w-6xl flex-col gap-12 px-4 py-16 md:flex-row md:items-center">
            <div className="md:w-1/2">
              ...
              <p className="mt-4 text-lg text-slate-600">
                Fast delivery, expert advice, and genuine products guaranteed.
                Get the care you need without leaving your home.
              </p>
              ...
              <div className="mt-10 grid gap-6 sm:grid-cols-3">
                {["Fast Delivery", "Certified Quality", "24/7 Support"].map(
                  (item) => (
                    <div
                      key={item}
              ...
              <div className="relative overflow-hidden rounded-[28px] bg-white shadow-soft">
                ...
                <div className="absolute bottom-6 left-6 right-6 rounded-2xl bg-white/90 p-4 shadow-lg backdrop-blur">
                  ...
                  <p className="text-xs text-slate-500">
                    Chat with licensed experts instantly for personal
                    recommendations.
                  </p>
                </div>
              </div>
          ...
          <div className="mx-auto max-w-6xl px-4">
            <div className="flex flex-col items-center text-center">
              ...
              <h2 className="mt-4 font-display text-3xl font-semibold text-slate-900">
                Your health needs, sorted for you
              </h2>
              <p className="mt-2 max-w-2xl text-slate-600">
                Explore our curated range of medicines, supplements, and care
                products tailored for every member of your family.
              </p>
            </div>
        ...
        <section
          id="about"
          className="bg-gradient-to-r from-primary/5 via-white to-primary/5 py-16"
        >
          <div className="mx-auto flex max-w-6xl flex-col gap-12 px-4 md:flex-row md:items-center">
            <div className="md:w-1/2 space-y-4">
              ...
              <h2 className="font-display text-3xl font-semibold text-slate-900">
                Personalized care with modern convenience
              </h2>
              <p className="text-base text-slate-600">
                We bring together experienced pharmacists, certified partners,
                and cutting-edge telehealth technology to ensure every
                prescription is handled with care. From remote consultations to
                doorstep delivery, your wellbeing is our mission.
              </p>
            ...
            <div className="md:w-1/2 grid gap-6 sm:grid-cols-2">
              {[
                ...
                <div
                  key={stat}
                  className="rounded-3xl border border-primary/20 bg-white px-6 py-8 text-center shadow-soft"
                >
          ...
          <div className="mx-auto max-w-6xl px-4">
            <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
              <div>
                ...
                <h2 className="mt-4 font-display text-3xl font-semibold">
                  Clinically tested & patient approved
                </h2>
              </div>
            ...
            <div className="mt-12 grid gap-6 md:grid-cols-2 xl:grid-cols-4">
              {featuredMedicines.map((medicine) => (
                <article
                  key={medicine.name}
                  className="flex h-full flex-col overflow-hidden rounded-3xl bg-white text-slate-900 shadow-xl"
                >
          ...
          <div className="grid gap-10 md:grid-cols-4">
            <div>
              ...
              <p className="mt-3 text-sm text-slate-400">
                ...
                Quality medicines, expert advice, and secure delivery.
              </p>
            </div>
            <div>
